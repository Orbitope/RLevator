...
namespace ElevatorRL.Editor
{
    ...
    public static class EvalHarness
    {
        ...
        // elev-e3-m-bignet-01 extended 5M -> 10M steps (reward still climbing at the 5M cutoff),
        // same reasoning as the other 5M->10M extensions.
        [MenuItem("Tools/Elevator RL/Run E3 Sweep (LOOK vs ETA vs PPO, rung M, bigger net, 10M steps, seeds 1-5)")]
        ...
        // EXPERIMENT_PLAN.md E3 rung L, resumed on E6's winning bignet2 (768x4) recipe. L =
        // 8 cars/30 floors (VectorObservationSize=648, see ElevatorSetup's baked-BrainParameters
        // log when Point Agent At L Preset was run).
        [MenuItem("Tools/Elevator RL/Run E3 Sweep (LOOK vs ETA vs PPO, rung L, bignet2, 5M steps, seeds 1-5)")]
        static void RunE3SweepLBignet2_5M() => RunScaleLadderSweep("L-bignet2-5M", 30, 8, 8,
            "Assets/ElevatorRL/Models/ElevatorController_L_e3_bignet2_5m.onnx", obsSize: 648);

        // elev-e3-l-bignet2-01 extended 5M -> 10M steps (reward still slowly improving at the 5M
        // cutoff, and the 5M result was severely behind LOOK/ETA).
        [MenuItem("Tools/Elevator RL/Run E3 Sweep (LOOK vs ETA vs PPO, rung L, bignet2, 10M steps, seeds 1-5)")]
